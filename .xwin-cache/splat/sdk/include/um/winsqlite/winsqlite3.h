...
/* sqlite3_filename was added in 3.40.0
   ...
   Therefore, some external APIs actually changed from a char* to const char*
   To avoid inflicting const-ness build breaks on legacy consumers,
...
struct sqlite3_vfs {
  ...
  int (SQLITE_CALLBACK *xOpen)(sqlite3_vfs*, _SQLITE_FILENAME zName, sqlite3_file*,
...
*/
SQLITE_API const char *SQLITE_APICALL sqlite3_uri_parameter(_SQLITE_FILENAME z, const char *zParam);
SQLITE_API int SQLITE_APICALL sqlite3_uri_boolean(_SQLITE_FILENAME z, const char *zParam, int bDefault);
SQLITE_API sqlite3_int64 SQLITE_APICALL sqlite3_uri_int64(_SQLITE_FILENAME, const char*, sqlite3_int64);
#if NTDDI_VERSION >= NTDDI_WIN10_CO
SQLITE_API const char *SQLITE_APICALL sqlite3_uri_key(_SQLITE_FILENAME z, int N);
#endif /* NTDDI_VERSION >= NTDDI_WIN10_CO */
...
*/
SQLITE_API const char *SQLITE_APICALL sqlite3_filename_database(_SQLITE_FILENAME);
SQLITE_API const char *SQLITE_APICALL sqlite3_filename_journal(_SQLITE_FILENAME);
SQLITE_API const char *SQLITE_APICALL sqlite3_filename_wal(_SQLITE_FILENAME);
...
*/
SQLITE_API _SQLITE_FILENAME_NONCONST SQLITE_APICALL sqlite3_create_filename(
...
SQLITE_API void SQLITE_APICALL sqlite3_free_filename(_SQLITE_FILENAME_NONCONST);
#endif /* NTDDI_VERSION >= NTDDI_WIN10_CO */
...
** </ul>
*/
SQLITE_API _SQLITE_FILENAME SQLITE_APICALL sqlite3_db_filename(sqlite3 *db, const char *zDbName);
